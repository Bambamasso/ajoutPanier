            ...
            <div class="articles">
                        ...
                        <?php if (!empty($paniers)) : ?>
                            <?php foreach ($paniers as $panier) : ?>
                                <tr>
                                    ...
                                    <td><input type="number" value="<?php echo $panier['quantité']; ?>" id="article<?php echo $panier['id']; ?>" min="1"></td>
                                    <td><?php echo number_format($panier['prix'], 2, '.'); ?></td>
                                    <td><?php echo number_format(($panier['prix'] * $panier['quantité']), 2, '.'); ?></td>
                ...
                <div class="bilan">
                    ...
                    <?php if (!empty($paniers)) : ?>
                        ...
                        <div class="detailBox">
                            <?php foreach ($paniers as $panier) : ?>
                                <?php $total += $panier['prix'] * $panier['quantité']; ?>
                                <div class="details">
                                    <p><?php echo $panier['nam']; ?></p>
                                    <p><?php echo $panier['quantité'] . ' x ' . number_format($panier['prix'], 2, '.'); ?></p>
                                    <p><?php echo number_format(($panier['prix'] * $panier['quantité']), 2, '.'); ?> FCFA</p>
                                </div>
                            <?php endforeach; ?>
